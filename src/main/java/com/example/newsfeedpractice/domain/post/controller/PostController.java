...
public class PostController {
     ...
     */
    @PostMapping("/create")
    public ResponseEntity <PostCreateResponseDto> createPost(@RequestBody createPostRequestDTO createRequest){
        PostCreateResponseDto newPost = postService.createPost(createRequest);
